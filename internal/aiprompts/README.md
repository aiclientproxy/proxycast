...
- **改插件包 / Plugin 包结构 / `plugin.json` / `mcp.json` / `skills/**/SKILL.md`**：先读 `../roadmap/plugin/v3/README.md` 与 `../roadmap/plugin/v3/01-target-contract.md`，再看 `skill-standard.md` 与 `governance.md`
