...
1. 按 EVENT-PROJECTIONS 逐项补 environment、fuzzy search、Windows sandbox 等仍在产品范围内且有真实 Desktop consumer 的 planned surface；Hook、warning 与 `turn/diff/updated` 已有 current owner，standalone `process/*` 和 Codex `thread/realtime/*` 均为 product-scope-excluded，不得恢复为第二套 current。音频、语音和媒体能力继续走 Grok-aligned provider/runtime owner。
...
| product-scope-excluded | standalone unsandboxed `process/outputDelta` / `process/exited` 与 Codex `thread/realtime/*`；只保留 upstream inventory 与脱敏 drift 诊断，不进入 current protocol、Renderer、Thread timeline 或音频播放                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
