...
impl ClientRequest {
    ...
    pub fn method(&self) -> Method {
        match self {
            ...
            Self::FuzzyFileSearch { .. } => Method::FuzzyFileSearch,
...
impl ClientResponsePayload {
    pub fn method(&self) -> Method {
        match self {
            ...
            Self::FuzzyFileSearch(_) => Method::FuzzyFileSearch,
    ...
    pub fn into_response(self, id: RequestId) -> Result<ClientResponse, serde_json::Error> {
        let result = match self {
            ...
            Self::FuzzyFileSearch(response) => serde_json::to_value(response)?,
