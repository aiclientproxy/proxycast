...
fn route_protocol_name(protocol: &ProtocolKind) -> &'static str {
    match protocol {
        ...
        ProtocolKind::OpenaiAudioSpeech => "openai_audio_speech",
        ProtocolKind::OpenaiAudioTranscription => "openai_audio_transcription",
        ProtocolKind::OpenaiEmbeddings => "openai_embeddings",
