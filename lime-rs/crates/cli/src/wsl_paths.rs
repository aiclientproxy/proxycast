...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\lime.zip").as_deref(),
            Some("/mnt/c/Temp/lime.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/lime.tgz").as_deref(),
            Some("/mnt/d/Work/lime.tgz")
        );
        assert!(win_path_to_wsl("/home/user/lime").is_none());
    }
