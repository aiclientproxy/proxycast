...
use crate::session_runtime::{ToolKind, ToolName};
...
pub(crate) struct RuntimeRequest {
    ...
    pub(crate) enabled_tools: Vec<RuntimeToolMetadata>,
    pub(crate) source: String,
}

#[derive(Clone)]
pub(crate) struct RuntimeToolMetadata {
...
struct RuntimeConfig {
    tool_call_id: String,
    enabled_tools: Vec<RuntimeToolMetadata>,
    source: String,
    stored_values: HashMap<String, JsonValue>,
}
