...
use code_mode_protocol::{FunctionCallOutputContentItem, ImageDetail, DEFAULT_IMAGE_DETAIL};
...
pub(super) fn normalize_output_audio(
    ...
    let result = (|| -> Result<FunctionCallOutputContentItem, String> {
        ...
        // Tiny generated clips are not useful as model audio input and are
        // commonly truncated by downstream encoders.
