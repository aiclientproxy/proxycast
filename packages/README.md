...
| `@limecloud/lime`                     | `npm install -g @limecloud/lime`                  | `lime` binary                         | CLI / TUI host                            | `lime`、`lime exec`、`lime execpolicy check`、`lime resume`、`lime thread`、`lime mcp`、`lime skills`             | App runtime、React UI、独立任务状态机                                                       | `lime` 命令                                                                                                                                                           |
