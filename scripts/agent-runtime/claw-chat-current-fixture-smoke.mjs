...
async function run() {
  ...
  const summary = {
    ...
    approvalRequestResumeServerRequestResponse: null,
    ...
    contentFactoryArticleWorkspaceProviderFixture: null,
    ...
    readModelSkillsRuntime: null,
    readModelExplicitSkillsRuntime: null,
    readModelManualEnableSkillsRuntime: null,
    readModelExpertSkillsRuntime: null,
    eventReadProbe: null,
